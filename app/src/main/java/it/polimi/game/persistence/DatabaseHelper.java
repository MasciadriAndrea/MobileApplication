...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public DatabaseHelper(Context applicationContext) {
        ...
        INSERT_MEGABRAIN = new String("insert into " + PLAYER + "("+PLAYER_FIELDS[1]+","+PLAYER_FIELDS[2]+","
                +PLAYER_FIELDS[3]+","+PLAYER_FIELDS[4]+","+PLAYER_FIELDS[5]+","+PLAYER_FIELDS[6]+") values (\"Megabrain\",0,0,0.0,0.0,0 )");
